...
The most popular preparation approach: practice using websites like LeetCode with time bounds. It is normal to not solve tasks quickly at first. For many people a few months of preparation is normal.
...
最流行的准备方法：在 LeetCode 等网站上限时练习。一开始不能快速解决问题是正常的。对很多人来说，几个月的准备是正常的。
