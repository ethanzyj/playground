...
In practice tasks you will see that sometimes sorting is needed in non-standard ways. Also, sometimes solving a task requires observations related to the sorted order of elements.
...
在练习任务中你会看到，有时需要以非标准方式进行排序。此外，有时解决任务需要对元素排序顺序进行观察。
