...
A sequence of items is usually represented with a structure called array or list. Each practice task will have a solution for further learning.

## Resources

- Educative lesson on finding the intersection point of two linked lists.
...
项目序列通常用称为数组或列表的结构来表示。每个练习任务都有解决方案供进一步学习。

## 资源

- Educative 关于查找两个链表交叉点的课程。
