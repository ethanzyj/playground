...
原因很多：缺乏理论知识、缺乏练习，以及在面试中解决这些问题时缺乏系统方法。网上充斥着解决每个问题的"菜谱"式方法……仿佛通读问题和背诵解答对任何人都有用似的！

## 我们的方法从根本上不同

我们中的一些人已经解决算法问题超过 20 年了，既为了乐趣也为了收益。很早的时候我们就开发了一套系统的方法来处理这些问题。HiredInTech 将这个过程教给每一个准备编程面试的人。

## 认识算法设计画布

配合正确的理论知识，算法设计画布将为你提供掌握算法设计问题所需的一切。

很多在 HiredInTech 与我们合作的人最终发现，通过应用正确的框架并使用解题网站，他们可以很快变得非常投入。我们希望你也能像我们一样着迷！
