...
1. What Are System Design Questions? (what-is-it.txt)
...
- 以混乱的方式处理问题，陷入细节无法自拔，或者
- 缺乏对如何正确设计可扩展架构的深入理解。

修复这两个问题将是本课程的重点。当你完成所有章节后，你将非常有能力应对任何系统设计问题。


## 系统设计流程

首先：我们将用结构化的系统设计方法来替代混乱。下一节中描述的"系统设计流程"将解决这个问题，它描述了从听到问题到宣布解决的所有步骤。

"系统设计流程"相当于算法设计领域中的"算法设计画布"。


## 设计可扩展架构

有了正确的流程之后，我们将着手消除你获得理想工作的第二个障碍。我们将花大量时间来建立你在设计可扩展架构方面的知识和直觉。

可扩展性是系统设计流程的第四步。我们在这上面花费了不成比例的时间，仅仅是因为这是候选人最容易遇到困难的地方。

为了增强你的可扩展性知识，我们精选了一些网上最好的阅读材料和视频。它们将教你设计可扩展系统的理论基础。然后，我们将专注于查看大量真实案例，包括一些互联网上最受欢迎的网站：Instagram、TripAdvisor、Salesforce.com、StackOverflow等等。

## 子章节

1. 什么是系统设计题？ (what-is-it.txt)
