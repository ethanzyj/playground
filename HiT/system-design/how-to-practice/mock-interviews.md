...
Nowadays, it is also possible to do mock interviews with other people online for free. One service that we found useful for this is Pramp.com - you could use it for your system design interview preparation.
...
模拟面试是练习系统设计问题的绝佳方式。系统设计问题的核心是围绕权衡的有机讨论。尝试找到一个客观且有知识的人，与他们进行几次面试。可以是朋友、同事，也可以使用付费服务。

付费模拟面试让你练习与陌生人自如地讨论想法，在时间压力下工作，并保证你获得客观的反馈。如果提供反馈的人擅长面试，你会得到很多行动建议和高质量的意见。

如果你选择与朋友做模拟面试，确保他们保持公正并给你诚实的反馈（朋友往往对我们太客气了）。与朋友做模拟面试的好处是他们会慷慨地花时间，所以你可以免费进行多次面试。但确保你选择一个有经验的面试官：与面试技能差的人做模拟面试意义不大。

如今，也可以在网上免费与其他人进行模拟面试。我们发现一个有用的服务是Pramp.com——你可以用它来准备系统设计面试。

无论你选择付费服务还是与朋友面试，模拟面试对你来说在系统设计问题方面都将非常有用。确保在正式面试前至少做几次模拟面试。
