...
- Nice YouTube channel about system design interviews
- System Design course from Educative.io (Paid)

## Sub-sections

1. Solve with Friends (solve-with-friends.txt)
2. Mock Interviews (mock-interviews.txt)
...
- 关于系统设计面试的优秀YouTube频道
- Educative.io的系统设计课程（付费）

## 子章节

1. 与朋友一起练习 (solve-with-friends.txt)
2. 模拟面试 (mock-interviews.txt)
3. 总结 (summary.txt)
