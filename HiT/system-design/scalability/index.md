...
Source: https://www.hiredintech.com/system-design/scalability/
...
1. Fundamentals (fundamentals.txt)
2. Examples (examples.txt)
3. Wrap-up (wrap-up.txt)
...
来源：https://www.hiredintech.com/system-design/scalability/

本节专门介绍使软件系统能够扩展的技术。扩展可以通过不同的方式实现，但通常与更多的流量、更多的请求、更多的用户有关。系统设计中会包含各种组件，它们都有各自适应不断增长需求的方式。通常，这涉及到各种权衡。在本节的第一课中，我们将从有用的学习材料开始，然后给出一些真实案例，最后以快速总结和关于如何在面试中应用这些知识的最终建议结束。

## 子章节

1. 基础知识 (fundamentals.txt)
2. 实例 (examples.txt)
3. 总结与建议 (wrap-up.txt)
