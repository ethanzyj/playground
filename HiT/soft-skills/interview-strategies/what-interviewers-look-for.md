...
随着时间推移，我们意识到许多求职者完全误解了面试的本质。许多人认为面试是一场战争，面试官会试图用刁难的问题来摧毁他们。这是人们感到紧张并且无法展示最好一面的原因之一。


## 在面试中

让我们进入实际的面试。面试的目标当然是检验你是否合适。无论如何，聪明的面试官会在候选人身上寻找几个特征来进行评估。它们是：
...
你在每一项上的表现最终将决定你的面试结果。仅在其中一项上表现出色（例如，能背诵Java源码）通常不足以获得录用。许多候选人认为面试的重点是解决给定的问题。解决问题确实至关重要，但正如我们将看到的，这还不够。我们经常听到人们抱怨他们解决了问题却仍然没有被录用。正如我们已经展示的，在评估候选人时有太多其他因素需要考虑。它们也可能对面试结果产生负面影响。


### 品格

品格是指人们在不同情况下的行为方式。例如，在困难的情况下，他们是否变得消极、作弊或刻薄？还是他们能很好地处理问题，展现出正直和对同事的支持？这一点非常重要，因为每个软件工程师通常都在团队中工作，与他人互动。如果你有一群最聪明的人但彼此之间无法很好地沟通，你仍然会从这个团队中得到糟糕的结果。


### 文化契合度

文化契合度是每家公司特有的东西。对于更知名的公司，你可以从它们的网站和各种出版物中了解其文化。这是拒绝聪明人的另一个常见原因。核心在于你是否与公司中其他人的特质相匹配。一个简化的例子是：如果公司里都是喜欢新科技产品、阅读大量关于新技术博客文章的极客，而你不是这样的人，那么可能就不会有很好的文化契合度。


### 智力

智力是指你处理新问题的方式。这就是为什么面试官看到你在面试中解决问题的过程非常重要。如果结果表明你只是记住了一些算法和问题，那么你可能无法解决对你来说全新的问题。


### 技能

技能是面试中测试的最后一个特征。它指的是你对各种编程语言、技术等的掌握程度。例如，你对Django、Ruby on Rails、C++等了解多少。我们认为这是四个特征中最不重要的一个。原因是，具备其他三个特征的人将能够快速掌握新技能。当然，可能有些公司需要高度专业化的技能，在这种情况下这个特征会更重要。


## 面试不是一场战争

最后，面试不是一个零和游戏：不是面试官赢你输，或者反过来。也不是面试官试图用你永远无法回答的不可能的问题来恐吓你，只是为了显示他们更聪明。

相反，面试是两个（或更多）人之间的友好对话，他们试图在短时间内形成对彼此的看法。面试被设计成快速高效的，因此才有这样的结构。但归根结底，它不过是一场关于有趣话题的对话：算法或系统设计——面试官往往和你一样紧张和焦虑。


## 总结

- 关于面试的一个常见误解，以及大多数面试官实际上是如何想的。
- 仅仅解决问题有时可能不够。
- 聪明的面试官会在候选人身上寻找四个主要特征。只具备其中一个是不足以被录用的。
