...
在技术面试中解决算法问题时，确保遵循"算法设计画布"中的所有步骤。系统设计问题同理，使用"系统设计流程"。有时候人们会因为兴奋而忘记做一件或多件重要的事情。


## 建议二：提出澄清性问题

强烈建议你在技术面试中不要做任何假设。这可能涉及问题描述中不清楚的事项、使用的编程语言或你可以直接使用的函数。例如，有时面试官希望你自己实现二分查找，而不是使用标准库中现成的。对这类事情保持开放的心态，不要假设任何不清楚的东西。这并不意味着你必须一直问愚蠢的问题。利用你的直觉，通过一些练习，你会找到平衡，学会什么是重要的需要问的，什么不需要。


## 建议三：解释你的思考过程

面试官想看到你是如何思考的。他们的目标之一是判断如果每天坐在你身边一起解决各种问题，他们是否会觉得自在。如果他们看不到你能表达自己的想法，这可能会对你的面试产生负面影响。

在解决问题时，尝试告诉面试官你正在经历什么样的思考。确保他们知道你进展到哪里了。即使你卡住了，也不要长时间保持沉默。告诉对方是什么让你困惑。这至少有两个积极的效果：一是面试官不会在一旁纳闷你脑子里到底在想什么；二是他们可能会给你一个提示，帮助你向前推进。


## 建议四：跟随面试官的提示

有时面试官会试图引导卡住的候选人朝正确的方向前进。我们看到过很多候选人直接忽略提示的情况。不要这样做。仔细听面试官在说什么，好好想想。这可能会帮助你达到最终目标。在面试中借助面试官的帮助来解决问题是完全可以的，这不会降低你获得工作的机会。


## 建议五：注意时间

如果可能的话，注意时间，不要在不重要的事情上浪费太多时间。有时候候选人会把时间浪费在谈论一些显而易见的事情上。正如我们在前面的建议中提到的，你需要解释你的思考过程，但这并不意味着要提及每一个细节。


## 额外建议：保持冷静和积极

记住，面试官最终是想录用你的。面试是一个认识有趣的人的机会，是就有趣的问题进行深入交流的机会，而且它很可能会带来你的下一份工作。确保把它当作一次积极的体验。

有时候候选人会对自己或自己的想法说一些消极的话，以防最终证明行不通。不要这样做。保持积极的态度，当你犯了错误时指出来，但不要沮丧，继续尝试解决问题。
