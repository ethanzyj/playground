...
Source: [https://www.hiredintech.com/soft-skills/interview-strategies/](https://www.hiredintech.com/soft-skills/interview-strategies/)
...
1. 5 Do's (5-dos.txt)
2. 5 Don'ts (5-donts.txt)
3. What Interviewers Look For (what-interviewers-look-for.txt)
...
来源：[https://www.hiredintech.com/soft-skills/interview-strategies/](https://www.hiredintech.com/soft-skills/interview-strategies/)

在面试中取得成功，不仅仅是练习算法设计或系统设计题目。还有另一个维度，与你在面试中的表现方式、你对面试流程的思考以及你的行为举止有关。

为了帮助你应对这方面的问题，我们列举了面试者在面试中最常犯的一些错误。面试的压力（尤其是如果你没有做过足够多的模拟面试）是非常大的，因此许多准备充分的候选人也会一再犯我们反复看到的错误。希望通过回顾这些错误并自我反思，你能在面试中避免它们。

此外，我们还想提一下面试者在面试中最容易忘记做的事情，请确保你充分理解它们。

"五个应该做的事"和"五个不应该做的事"旨在提供高度实用的建议：它们不是理论性的建议，而是你可以在下一次真实面试或模拟面试中立即应用的具体实用技巧。

最后，我们想一劳永逸地定义面试到底是什么。我们发现许多候选人在面试方面有错误（或不完整）的认知。他们误解了面试官在寻找什么，认为只要解决给出的问题就足够了。事实并非如此——而且有充分的理由。本节的最后部分将涵盖这个主题，展示我们作为面试官是如何思考的。

## 子章节

1. 五个应该做的事 (5-dos.txt)
2. 五个不应该做的事 (5-donts.txt)
3. 面试官看重什么 (what-interviewers-look-for.txt)
