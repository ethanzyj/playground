...
我们已经以各种形式说过这一点，但它值得再次提及。不要假设那些没有明确说明的事情。例如，你不能自行假设问题中的数字是整数。它们也可能是浮点数，或者有几百位数字。提出问题来澄清这些细节。


## 错误二：沉默太久

有时候我们看到的是，面试者被给出一个问题后就闭嘴不说话了。你知道他们在思考，但无法知道他们脑子里到底在想什么。面试的部分目的是让面试官了解你的思维方式。因此你必须展示出来。谈谈你的想法和面临的挑战，进行对话。


## 错误三：在显而易见的事情上浪费太多时间

这是上一点的反面。有些人说得太多，事无巨细。找到平衡点，展示你的思考过程，但不要描述那些显而易见的东西。面试官肯定能理解它们。


## 错误四：立即开始写代码

即使你知道如何解决一个问题（或者你认为你知道），也不要急着立即写代码。在此之前，你需要向面试官解释你的想法并讨论复杂度。在解决方案设计确定之前，可能需要几次迭代。确保你们都选好了编程语言，然后才开始写代码。通常，使用"算法设计画布"来建立结构化的步骤序列。


## 错误五：写代码时复制粘贴

如果是在白板或纸上写代码，这不太容易做到。然而在远程面试中使用共享文档时，我们看到很多候选人这样做。你可能知道在实际工作中这是一种不好的做法。所以，想办法避免它。更好地组织你的代码并复用公共逻辑。如果你发现自己想在编辑器中复制粘贴某些东西，想想如何重新组织你当前的解决方案。


## 额外错误：假设面试官总是对的

有时候面试官可能是错的——毕竟我们都会犯错。有时候他们会故意不同意你的观点，看看你如何应对批评。无论是什么情况，确保你冷静地解释和捍卫你的思考过程。不要做一个唯唯诺诺的人，但另一方面，也不要侮辱面试官说他们很笨。
