...
一般来说：绝对不会。面试官是开发人员，面试结束后还要回到自己的工位继续工作。没有时间去编译代码，尤其是如果代码是写在白板或纸上的。而且，通常他们并不真正在意代码是否能编译。他们通过看代码就能评估。如果有严重问题，面试官能够发现。毕竟他们是专业人士，而且他们已经看过很多次同样问题的解决方案了。


## 问题二：面试有典型的结构吗？

是的，顶级软件公司的技术面试有一个典型的结构。结构可能取决于面试是通过电话还是当面进行的，也可能因公司而略有不同。但是，这些面试中会出现一些明显的模式。

通常，技术面试会以5分钟开始，面试官在这段时间里自我介绍。可能会有一些闲聊，比如天气、你是怎么到办公室的等等，希望能打破僵局。你也可能会被问到与简历相关的问题。

之后是面试官提出技术问题、你来解答的环节。这大概会持续40-45分钟。最后你很可能有5分钟左右的时间提出你的问题（如果有的话）。大致就是这样。

当然，如果面试是针对产品经理或测试职位的，问题会与软件开发职位不同，但通常结构保持不变。
